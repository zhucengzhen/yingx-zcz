        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="${path}/login/login.jsp" >退出<span class="glyphicon glyphicon-log-out"></span></a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                ...
                <div class="panel panel-success">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <a href="javascript:$('#mainId').load('${path}/admin/admin.jsp')">管理员展示</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                        <div class="panel-body">
                            <a href="javascript:$('#mainId').load('${path}/video/showVideo.jsp')">视频展示</a>
                        </div>
                    </div>
                </div>
