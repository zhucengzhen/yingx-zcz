                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form"  action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <label for="vcodes" class="control-label col-sm-3">验证码：</label>
                                <div class="col-sm-5">
                                    <input type="text" name="code" id="vcodes" class="form-control">
                                </div>
                                <div class="col-sm-4">
                                    <img id="changeimg" onclick="change()" src="${pageContext.request.contextPath}/admin/yzm" alt="" style="width: 100%">
                                </div>
